...
import herobg from "../../../assets/services/servicesbanner.png";
    ...
    return (
        <div className="relative w-full h-[300px]  md:h-[400px] lg:h-[420px] overflow-hidden mt-[rem] ">
            ...
            <div className="relative h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
                {/* Main Heading */}
                <h1
                    className="text-white text-center uppercase text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight  sm:mb-1 md:mb-6 mt-10"
